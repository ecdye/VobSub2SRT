...
struct cmd_options {
  ...
  cmd_options &add_option(char const *name, bool &val, char const *description,
                          char short_name = '\0');
  cmd_options &add_option(char const *name, std::string &val,
                          char const *description, char short_name = '\0');
  cmd_options &add_option(char const *name, int &val, char const *description,
                          char short_name = '\0');

  cmd_options &add_unnamed(std::string &val, char const *help_name,
